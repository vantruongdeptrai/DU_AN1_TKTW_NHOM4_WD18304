                    ...
                    <div class="services_section_inner d-flex justify-content-between">
                        ...
                        <div class="single_services one text-center wow fadeInUp" data-wow-delay="0.1s"
                            ...
                            <div class="services_content">
                                <h3><a href="index.php?act=shop-left-sidebar">Pastry</a></h3>
                                ...
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="index.php?act=single-product"><img src="assets/img/product/product1.png"
                                                    alt=""></a>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <article class="single_product">
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="index.php?act=single-product"><img src="assets/img/product/product5.png"
                                                    alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html" title="Add to cart">
                ...
                <div class="col-lg-4">
                    <div class="single_blog wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                        <div class="blog_thumb">
                            <a href="index.php?act=blog-detail-left-sidebar"><img src="assets/img/blog/blog1.png" alt=""></a>
                        </div>
