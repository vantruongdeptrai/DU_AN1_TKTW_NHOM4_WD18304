<?php
function insert_ctsp($id_sp,$id_size){
...
//     return $list_chitietsp;
// }
function update_ctsp($id_ctsp,$id_sp,$id_size){
    $sql = "UPDATE chi_tiet_sp SET id_sp = '$id_sp' , id_size = '$id_size' WHERE id_ctsp = '$id_ctsp'";
    pdo_execute($sql);
}
