<?php
    function insert_lichsu_mua($id_ctsp,$id_user,$so_luong){
        $sql = "INSERT INTO lich_su_mua(id_ctsp,id_user,so_luong) VALUES ('$id_ctsp','$id_user','$so_luong')";
        //echo $sql;
        pdo_execute($sql);
    }
    function load_lichsu_mua(){
        $sql = "SELECT lich_su_mua.so_luong,lich_su_mua.id_lichsu_mua , san_pham.ten_sp ,san_pham.gia , san_pham.hinh_anh , size.ten_size , chi_tiet_sp.id_ctsp , nguoi_dung.user
        FROM lich_su_mua 
