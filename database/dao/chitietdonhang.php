<?php 
    ...
    function loadall_chitiet_donhang(){
        $sql = "SELECT don_hang.id_user , gio_hang.so_luong , chi_tiet_donhang.tong_tien , trang_thai.ten_trangthai,chi_tiet_donhang.id_pttt, chi_tiet_donhang.ngay_dat_hang , chi_tiet_donhang.id_don_hang ,chi_tiet_donhang.id_gio_hang
