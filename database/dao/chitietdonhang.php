<?php 
    ...
    function update_chitiet_donhang($id_chitietdon_hang,$id_trangthai){
        $sql = "UPDATE chi_tiet_donhang SET id_trangthai = '$id_trangthai' WHERE id_chitietdon_hang='$id_chitietdon_hang'";
        pdo_execute($sql);
    }
