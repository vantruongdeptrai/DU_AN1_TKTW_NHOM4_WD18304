<?php 
    ...
    function load_donhang_iduser($id_user){
        $sql = "SELECT chi_tiet_donhang.id_chitiet_donhang , don_hang.id_user , chi_tiet_giohang.so_luong , chi_tiet_donhang.tong_tien , trang_thai.ten_trangthai,trang_thai.id_trangthai,chi_tiet_donhang.id_pttt, don_hang.ngay_dat_hang , don_hang.id_don_hang ,chi_tiet_giohang.id_chitiet_gh
        FROM chi_tiet_donhang
        LEFT JOIN don_hang ON don_hang.id_don_hang = chi_tiet_donhang.id_don_hang
        LEFT JOIN chi_tiet_giohang ON chi_tiet_giohang.id_chitiet_gh = chi_tiet_donhang.id_chitiet_gh
        LEFT JOIN trang_thai ON trang_thai.id_trangthai = chi_tiet_donhang.id_trangthai
    ...
    function load_chitiet_giohang_id_ctdh($id_don_hang){
        ...
        LEFT JOIN don_hang ON don_hang.id_don_hang = chi_tiet_donhang.id_don_hang 
        LEFT JOIN chi_tiet_giohang ON chi_tiet_donhang.id_chitiet_gh = chi_tiet_giohang.id_chitiet_gh WHERE don_hang.id_don_hang = '$id_don_hang'";
        $load_ctgiohang_id_ctdh = pdo_query($sql);
        return $load_ctgiohang_id_ctdh;
    }
?>